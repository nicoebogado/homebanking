...
class TbFormInputElement extends CFormElement {
	...
	protected function generateGroupOptions() {
		...
		$options = array();
		$fields = array('groupOptions', 'widgetOptions', 'label', 'labelOptions', 'errorOptions', 'hint', 'hintOptions', 'prepend', 'prependOptions',
			'append', 'appendOptions', 'enableAjaxValidation', 'enableClientValidation', 'select');
	...
	public function render() {
		...
		if($this->type === 'hidden') $options = null;
