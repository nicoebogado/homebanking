...
class ExtractOnRequest extends EPDF
{
	/**
	...
	public function init()
	{
		...
		if ($header) {
			...
			$this->config['secondHeaderRenderizer'] = function ($pdfObj) use ($header) {
				...
				$pdfObj->SetFont('Arial', 'b', 7.5);
				$pdfObj->Cell(21, 11, 'Fecha Conf.', 0, 0, 'C','T');
				$pdfObj->Cell(0.1, 5, '', 0, 0);

				$pdfObj->SetFont('Arial', 'b', 7.5);
				$pdfObj->Cell(21, 11, 'Fecha Tran.', 0, 0, 'C','T');
				$pdfObj->Cell(0.1, 5, '', 0, 0);

				$pdfObj->SetFont('Arial', 'b', 7.5);
				$pdfObj->Cell(21, 11, 'Nro Comprob.', 0, 0, 'C','T');
				$pdfObj->Cell(0.1, 5, '', 0, 0);

				$pdfObj->SetFont('Arial', 'b', 7.5);
				$pdfObj->Cell(21, 11, 'Concepto', 0, 0, 'C','T');
				$pdfObj->Cell(0.1, 5, '', 0, 0);

				$pdfObj->SetFont('Arial', 'b', 7.5);
				$pdfObj->Cell(21, 11, 'Importe Deb.', 0, 0, 'C','T');
				$pdfObj->Cell(0.1, 5, '', 0, 0);
