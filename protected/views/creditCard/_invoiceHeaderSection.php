            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <?= $this->renderPartial('_invoiceHeaderItem', [
                        'icon' => 'money',
                        'title' => 'Pago Mínimo',
                        'content' => Yii::app()->numberFormatter->formatDecimal($balance->Pagominpendiente),
                    ]) ?>
                </div>
                ...
                <div class="col-md-4">
                    <?= $this->renderPartial('_invoiceHeaderItem', [
                        ...
                        //added:01-04-2022,Higinio Samaniego, se corrige error en fecha de origen de bancard
