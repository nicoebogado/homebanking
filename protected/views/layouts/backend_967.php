      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
          ...
          <a class="visible-md" href="#">
            ...
            <?php echo count($name) > 1 ? $name[0] . ' ' . $name[1] : $name[0] ?>
          </a>
        </li>
        <!--<li>
          <a data-toggle="tooltip" title="Chat On-Line" data-original-title="Chat On-Line" id="chatbt" href="#">
            <em class="icon-earphones-alt"></em>
          </a>
        </li>-->
          ...
          <ul class="dropdown-menu animated flipInX">
            <li>
              <div class="list-group">
                ...
                <a href="#" class="list-group-item text-center"><?php echo Yii::t('menu', 'Cambiar Idioma') ?></a>
                <div class="row">
                  <div class="col-md-6">
                    <a href="<?php echo CHtml::normalizeUrl(array('/appConfig/language', 'id' => 'es')) ?>" class="list-group-item">
                      <div class="media-box">
                        <?php echo HImage::html('Spain.png', 'ES'); ?>
                      </div>
                    </a>
                  </div>
                  <div class="col-md-6">
                    <a href="<?php echo CHtml::normalizeUrl(array('/appConfig/language', 'id' => 'en')) ?>" class="list-group-item">
                      <div class="media-box">
                        <?php echo HImage::html('United States of America(USA).png', 'ES'); ?>
                      </div>
                    </a>
                  </div>
                </div>
