...
$this->pageTitle = Yii::app()->name . ' - ' . Yii::t('changePassword', 'Cambiar Clave Transaccional');
?>

<h3><?php echo Yii::t('changePassword', 'Cambiar Clave Transaccional') ?></h3>
<div class="panel panel-warning">
    <div class="panel-heading"> Recomendaciones</div>
    <div class="panel-body">

        <ul>
            <li>No puede repetir el mismo carácter en la clave en forma consecutiva.</li>
