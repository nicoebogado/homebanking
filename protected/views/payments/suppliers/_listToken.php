<?php
	...
	'columns'=>array(
		...
		array(
			'name' => Yii::t('commons', 'Cuenta Crédito'),
			'type' => 'raw',
			'value' => 'isset($data->numerocuentacredito)?
				CHtml::textField("correctedAccounts[$data->numerocuentacredito]",$data->numerocuentacredito):
				CHtml::textField((isset($data->numerocuentabeneficiario)?$data->numerocuentabeneficiario:""))
			',
		),
	...
	'columns'=>array(
		...
		array(
			'name' => Yii::t('commons', 'Cuenta Crédito'),
			'type' => 'raw',
			'value' => 'isset($data->numerocuentacredito)? $data->numerocuentacredito:(isset($data->numerocuentabeneficiario)?$data->numerocuentabeneficiario:"")',
		),
