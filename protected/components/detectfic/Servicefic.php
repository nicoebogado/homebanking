...
abstract class Servicefic extends CComponent
{
    const TAG = 'components.DetectFic.Servicefic';
    ...
    {
        $numeroRandom = random_int(999,9999);
        $numeroRamdomico = (String)$numeroRandom;
        //Yii::log($numeroRamdomico.':'.$this->client->__getLastRequest(), 'info', static::TAG);
        Yii::log($numeroRamdomico.':'.$this->client->__getLastRequest(), 'info', static::TAG);
        Yii::log($numeroRamdomico.':'.$this->client->__getLastResponse(), 'info', static::TAG);
    }
}
